---
tag: prompt
criador: Professor Sandeco Macedo (sandecom@gmail.com)
modelo: chatgpt4
---

## Descrição

"Prompt Matrix", chatGPT em nível avançado. Um método de ensino inovador em que uma entidade cognitiva de alto nível, a Mente Superior, cria duas entidades secundárias para um diálogo educativo personalizado. O estudante e o professor, guiados pela Mente Superior, embarcam numa jornada de aprendizagem dinâmica, com o nível de complexidade e tamanho das respostas totalmente adaptáveis. Nesta experiência única, os usuários têm controle total sobre o fluxo da conversa, criando um ambiente de aprendizado personalizado e interativo. Junte-se a nós neste vídeo e explore esta fascinante abordagem de aprendizagem.

## Vídeo Tutorial

![](https://www.youtube.com/watch?v=IEAO1gfA04U&ab_channel=CANALSANDECO)
